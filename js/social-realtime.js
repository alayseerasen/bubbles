...
updateMessagesBadge();
         ...
         * ==================================================
         *
         * Раньше здесь дёргался renderMessages(), который
         * полностью перерисовывает всю страницу «Сообщения» —
         * включая поле ввода. Из-за этого у собеседника
         * стирался недопечатанный текст и страницу
         * подбрасывало наверх при каждом новом сообщении,
         * даже своём собственном. Вместо этого просто
         * добавляем один пузырёк в чат, как и для
         * собственных сообщений в sendMessage().
         */
